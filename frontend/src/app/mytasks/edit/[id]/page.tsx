...
export default function EditTaskPage() {
  ...
  return (
    <main className="pb-[3.6rem] sm:pb-0 relative w-full h-full">
      ...
      <div className="py-4 sm:pt-4 pb absolute left-1/2 top-4 sm:top-1/2 transform -translate-x-1/2 sm:-translate-y-1/2 z-10 bg-white shadow-xl   w-[90%] md:w-[80%] lmd:w-[48%] rounded-3xl">
        ...
        <form
              ...
              className="flex flex-col gap-3 mt-5 md:mt-6 w-[85%] mx-auto italic text-sm sm:text-lg"
            >
              ...
              <div className="bg-black  text-white px-4 py-3 text-center rounded-2xl mt-2 ml-auto ">
